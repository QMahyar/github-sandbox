    ...
    <div id="captcha_msg">
        ...
        <div class="DownloadRepair-captchaComplete">
            ...
            <p id="captcha_complete_alt" style="display: none;">
                If your download does not start, <a href="/file/zuvjgzkjzukxw6m/Modartt_-_Pianoteq_v9.1.0_Full_Setup.rar/file" id="captcha_complete_link">click here</a>.
            </p>
        </div>
    </div>
</div>
...
</script><form id="recaptchaForm" action="/file/zuvjgzkjzukxw6m/Modartt_-_Pianoteq_v9.1.0_Full_Setup.rar/file" method="post" style="display: none;">
...
<script>
    ...
    mfRecaptchaBus.addEventListener('solved', function(data) {
        ...
        // New page
        let downloadPageSolved = '/file/zuvjgzkjzukxw6m/Modartt_-_Pianoteq_v9.1.0_Full_Setup.rar/file?g-recaptcha-response=' + encodeURIComponent(data.detail.token);
        let downloadPageNotLoading = '/file/zuvjgzkjzukxw6m/Modartt_-_Pianoteq_v9.1.0_Full_Setup.rar/file?captcha-failure=1';
