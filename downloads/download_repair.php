    ...
    <div id="captcha_msg">
        ...
        <div class="DownloadRepair-captchaComplete">
            ...
            <p id="captcha_complete_alt" style="display: none;">
                If your download does not start, <a href="/file/l08mniesb2j945n/Roland_ZENOLOGY_Pro_v2.0.7_WIN-VR.rar/file" id="captcha_complete_link">click here</a>.
            </p>
        </div>
    </div>
</div>
...
</script><form id="recaptchaForm" action="/file/l08mniesb2j945n/Roland_ZENOLOGY_Pro_v2.0.7_WIN-VR.rar/file" method="post" style="display: none;">
...
<script>
    ...
    mfRecaptchaBus.addEventListener('solved', function(data) {
        ...
        // New page
        let downloadPageSolved = '/file/l08mniesb2j945n/Roland_ZENOLOGY_Pro_v2.0.7_WIN-VR.rar/file?g-recaptcha-response=' + encodeURIComponent(data.detail.token);
        let downloadPageNotLoading = '/file/l08mniesb2j945n/Roland_ZENOLOGY_Pro_v2.0.7_WIN-VR.rar/file?captcha-failure=1';
